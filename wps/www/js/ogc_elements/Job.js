...
export class Job {
     ...
     * @param {[{href: string, rel: string, title: string, type: string}]} options.links -
     * The associated links for the Job.
    ...
    /**
     * Determines if the result link is currently available and returns the associated URL.
     *
    ...
    /**
     * Retrieves the links associated with the current Job.
     *
     * @return {[{href: string, rel: string, title: string, type: string}]}
     * Links stored in the Job.
     */
    getLinks() {
        return this._links;
    }
