...
export class Process {
     ...
     * @param {[{href: string, rel: string, title: string, type: string}]} links -
     ...
     */
    constructor(description, id, listInputs, listOutputs, links, title) {
    ...
    /**
     * Retrieves the collection of links.
     * @return {{href: string, rel: string, title: string, type: string}[]}
     * The list of links or a representation of links depending on the implementation.
     */
    getLinks() {
        return this._links;
    }
